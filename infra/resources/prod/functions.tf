...
module "functions_app" {
  ...
  app_settings = {
    ...
    INTERNAL_STORAGE_FALLBACK_CONNECTION_STRING = module.storage_account.primary_connection_string
    INTERNAL_STORAGE_CONNECTION_STRING          = module.storage_account_itn.primary_connection_string
